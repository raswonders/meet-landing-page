...
export function Footer() {
  return (
    <>
      ...
      <footer className="relative -z-20 py-16 px-8 bg-cover bg-[url('/assets/mobile/image-footer.jpg')]">
        <div className="absolute -z-10 inset-0 bg-cyan-600 opacity-90"></div>
        <div className="flex flex-col justify-center text-white gap-6 text-center">
